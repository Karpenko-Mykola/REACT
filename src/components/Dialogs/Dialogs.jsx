		...
		<div className = {style.dialogs}>
			<div className = {style.dialogs_items}>
				...
				<div className = {style.dialogs_messages}>
		            {Messages}
					<input type="text" value = {props.state.dialogAraeValue} onChange = {(event) => props.dispatch(messageInputChangeActionCreator(event.target.value))}/>
					<button className = {style.dialogs_messages_button} onClick = {() => props.dispatch(addMessageactionCreator())}>Send</button>
				</div>
		</div>
	</div>
